...
from agents.value_function import NNValueFunction
import scipy.signal
...
def run_episode(env, policy, scaler, rendering=False):
...
def main(env_name, num_episodes, gamma, lam, kl_targ, batch_size, hid1_mult, policy_logvar, clipping_range):
    ...
    policy = PPO_Policy(obs_dim, act_dim, kl_targ, hid1_mult, policy_logvar, clipping_range)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-env_name', type=str, help='OpenAI Gym environment name', default='Pendulum-v0')
